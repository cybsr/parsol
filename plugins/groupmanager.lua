...
return '#》_گروه در لیست دیتا بیس قبلا بوده است✅♻️_'
  end
end
  ...
  return '#》گروه به لیست دیتا بیس اضافه شد✅'
end
end
...
local lang = redis:get(hash)
  ...
  if not lang then
    ...
    return '_#》گروه در لیست دیتا بیس نیست❌❗️_'
   end
  end
 ...
 if not lang then
  ...
  return '_#》گروه از لیست دیتا بیس حذف شد✅_'
end
end
